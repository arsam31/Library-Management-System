using Library.Auth.AuthLogger;
using Library.Auth.Constants;
using Library.Auth.Managers;
...
namespace Library.Auth.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        [HttpPost("Login")]
        public async Task<IActionResult> Signin([FromBody] Library.Auth.Models.LoginRequest login)
        {
            try
            {
                // Validate the model
